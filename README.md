Tentando fazer uma "demonstração" de como um operador lógico "ou esclusivo" (ou porta XOR) pode ser representado a partir de apenas operadores "não e" (ou portas NAND). 
